...
using WebApi_inspeccionesPert.Models;
using WebApi_inspeccionesPert.Providers;
using WebApi_inspeccionesPert.Results;

namespace WebApi_inspeccionesPert.Controllers
{
    [Authorize]
